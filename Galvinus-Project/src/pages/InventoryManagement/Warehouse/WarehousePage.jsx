...
const WarehousePage = () => {
	...
	useEffect(() => {
		setCreateBtn("Create Warehouse");
		setEditBtn("Edit Warehouse");
		setDisplayBtn("Display Warehouse");
		setCreateUrl("/createwarehouse");
		setEditUrl("/editwarehouse");
		setDisplayUrl("/displaywarehouse");
	}, []);
